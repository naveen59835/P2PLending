...
export class LoanService {
 ...
 //apiBaseUrl = environment.apiBaseUrl + '/loan-service';
  ...
  getAllLoans(id:string,role:string){
    return this.http.get(`https://lendinglane.stackroute.io/api/v1/loan/Loan?id=${id}&role=${role}`);
  }
  applyLoan(data :any){
    data.borrowerId = localStorage.getItem("email");
    //return this.http.post(this.apiBaseUrl + "/api/v1/loan/create",data);
    return this.http.post("https://lendinglane.stackroute.io/api/v1/loan/create",data);
  }
  getLoan(loanId:string){
  // return this.http.get(this.apiBaseUrl + "/api/v1/loan/getLoan/"+loanId)
    return this.http.get("https://lendinglane.stackroute.io/api/v1/loan/getLoan/"+loanId)
  }
  getLenderLoans(){
   //return this.http.get(this.apiBaseUrl + "/api/v1/loan/getLenderLoan/"+localStorage.getItem("email"))

    return this.http.get("https://lendinglane.stackroute.io/api/v1/loan/getLenderLoan/"+localStorage.getItem("email"))
